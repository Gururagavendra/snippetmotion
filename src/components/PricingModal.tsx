          ...
          {view === "pricing" && (
            ...
            >
              <DialogHeader className="space-y-4 mb-6">
                ...
                <div className="flex justify-center">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30">
                    <span>🎉</span>
                    <span className="text-sm font-semibold text-primary tracking-wide">LAUNCH SPECIAL</span>
                  </div>
                </div>
              ...
              <div className="flex justify-center mb-3">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[hsl(220,50%,15%)] border border-primary/40 shadow-[0_0_12px_hsl(var(--primary)/0.3)]">
                  <Sparkles className="w-4 h-4 text-primary" />
                  <span className="text-sm font-medium text-foreground">Lifetime License — Pay Once, Use Forever</span>
                </div>
              </div>
              ...
              <div className="text-center mb-6">
                <span className="text-lg text-muted-foreground line-through mr-3">$29.00</span>
                <span className="text-6xl font-bold bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">$9.99</span>
              ...
              <Button 
                asChild
                className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-primary to-accent text-background btn-glow hover:opacity-90 transition-opacity group"
              >
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <Input
                  ...
                  className="h-14 text-center text-lg font-mono uppercase tracking-wider"
                />
                {error && (
              ...
              <Button 
                ...
                className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-primary to-accent text-background btn-glow hover:opacity-90 transition-opacity"
              >
                Activate
              </Button>
